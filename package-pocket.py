...
# release contains everything needed to produce tp84.rom.
for extra in ("tp84.mra", "README.md", os.path.join("tools", "mra_build.py")):
...
print("build the ROM with:  python3 mra_build.py tp84.mra tp84.zip")
